...
export default function Thesis() {
    ...
    let images = [
        ...
        "/images/VORPAL/vorpal.png",
        // "/images/VORPAL/vorpal2.png",
        "/images/VORPAL/vorpal3.png",
        "/images/VORPAL/vorpal4.png",
        ...
        <main className=" lg:mt-[50px] pt-8">
            ...
            <div className="mt-10 mb-20 space-y-8">
                ...
                <p className="text-lg text-zinc-400">
                    Legend has it that deep in the heart of a cursed necropolis an ancient king was entombed along with his priceless crown. While many have gone down into its depths, none have survived. None that is, except for you. Armed with a Vorpal Sword and an ability to shift prismatic light you will be able to explore the necropolis and liberate the riches within!
                    <br /><br />
